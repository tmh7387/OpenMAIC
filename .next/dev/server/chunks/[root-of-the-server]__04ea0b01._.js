...
"[project]/app/api/server-providers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])('ServerProviders');
async function GET() {
    try {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiSuccess"])({
            providers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$provider$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerProviders"])(),
            tts: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$provider$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerTTSProviders"])(),
            asr: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$provider$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerASRProviders"])(),
            pdf: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$provider$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerPDFProviders"])(),
            image: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$provider$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerImageProviders"])(),
            video: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$provider$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerVideoProviders"])(),
            webSearch: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$provider$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getServerWebSearchProviders"])()
        });
    } catch (error) {
        log.error('Error fetching server providers:', error);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('INTERNAL_ERROR', 500, error instanceof Error ? error.message : 'Unknown error');
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__04ea0b01._.js.map