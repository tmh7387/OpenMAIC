...
"[project]/app/api/generate/scene-actions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])('Scene Actions API');
...
async function POST(req) {
    ...
    try {
        ...
        const { outline, allOutlines, content, stageId, agents, previousSpeeches: incomingPreviousSpeeches, userProfile } = body;
        ...
        if (!content) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('MISSING_REQUIRED_FIELD', 400, 'content is required');
        }
        if (!stageId) {
        ...
        const scene = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generation$2f$scene$2d$builder$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildCompleteScene"])(outline, content, actions, stageId);
        if (!scene) {
            log.error(`Failed to build scene: "${outline.title}"`);
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('GENERATION_FAILED', 500, `Failed to build scene: ${outline.title}`);
        }
        // ── Extract speeches for cross-scene coherence ──
        const outputPreviousSpeeches = (scene.actions || []).filter((a)=>a.type === 'speech').map((a)=>a.text);
        log.info(`Scene assembled successfully: "${outline.title}" — ${scene.actions?.length ?? 0} actions`);
        ...
        log.error(`Scene actions generation failed [scene="${outlineTitle ?? 'unknown'}", model=${resolvedModelString ?? 'unknown'}]:`, error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__646e35c2._.js.map