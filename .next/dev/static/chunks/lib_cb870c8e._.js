...
"[project]/lib/utils/chat-storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function saveChatSessions(stageId, sessions) {
    if (!sessions || sessions.length === 0) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].chatSessions.where('stageId').equals(stageId).delete();
        return;
    }
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].transaction('rw', __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].chatSessions, async ()=>{
        // Delete old sessions for this stage, then bulk insert new ones
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].chatSessions.where('stageId').equals(stageId).delete();
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].chatSessions.bulkPut(records);
    });
}
async function loadChatSessions(stageId) {
    const records = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].chatSessions.where('stageId').equals(stageId).sortBy('createdAt');
...
"[project]/lib/utils/playback-storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function savePlaybackState(stageId, snapshot) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].playbackState.put({
        stageId,
...
async function loadPlaybackState(stageId) {
    const record = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].playbackState.get(stageId);
...
async function clearPlaybackState(stageId) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].playbackState.delete(stageId);
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/lib/utils/stage-storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils/database.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$chat$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils/chat-storage.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$playback$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils/playback-storage.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/logger.ts [app-client] (ecmascript)");
;
;
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createLogger"])('StageStorage');
async function saveStageData(stageId, data) {
    try {
        const now = Date.now();
        // Save to stages table
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].stages.put({
            id: stageId,
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].scenes.where('stageId').equals(stageId).delete();
        // Save new scenes
        if (data.scenes && data.scenes.length > 0) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].scenes.bulkPut(data.scenes.map((scene, index)=>({
                    ...scene,
                    stageId,
        ...
        if (data.chats) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$chat$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveChatSessions"])(stageId, data.chats);
        }
...
async function loadStageData(stageId) {
    try {
        // Load stage
        const stage = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].stages.get(stageId);
        if (!stage) {
            log.info(`Stage not found: ${stageId}`);
            return null;
        }
        // Load scenes
        const scenes = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].scenes.where('stageId').equals(stageId).sortBy('order');
        // Load chat sessions from independent table
        const chats = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$chat$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadChatSessions"])(stageId);
...
async function deleteStageData(stageId) {
    try {
        // Delete stage
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].stages.delete(stageId);
        // Delete scenes
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].scenes.where('stageId').equals(stageId).delete();
        // Delete chat sessions and playback state
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$chat$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteChatSessions"])(stageId);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$playback$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clearPlaybackState"])(stageId);
...
async function listStages() {
    try {
        const stages = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].stages.orderBy('updatedAt').reverse().toArray();
        const stageList = await Promise.all(stages.map(async (stage)=>{
            const sceneCount = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].scenes.where('stageId').equals(stage.id).count();
            return {
                id: stage.id,
                name: stage.name,
        ...
        await Promise.all(stageIds.map(async (stageId)=>{
            ...
            if (firstSlide && firstSlide.content.type === 'slide') {
                ...
                if (placeholderEls.length > 0) {
                    const mediaRecords = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].mediaFiles.where('stageId').equals(stageId).toArray();
...
async function renameStage(stageId, newName) {
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$database$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].stages.update(stageId, {
            name: newName,
            updatedAt: Date.now()
        });
...
//# sourceMappingURL=lib_cb870c8e._.js.map