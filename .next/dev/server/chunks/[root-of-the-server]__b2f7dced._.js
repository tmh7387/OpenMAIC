...
"[project]/app/api/generate/scene-outlines-stream/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])('Outlines Stream');
 ...
 */ function extractNewOutlines(buffer, alreadyParsed) {
    const results = [];
...
async function POST(req) {
    ...
    try {
        ...
        if (!body.requirements) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('MISSING_REQUIRED_FIELD', 400, 'Requirements are required');
        }
        ...
        if (!prompts) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('INTERNAL_ERROR', 500, 'Prompt template not found');
        }
                ...
                try {
                    ...
                    const streamParams = visionImages?.length ? {
                        ...
                        messages: [
                            {
                                role: 'user',
                                content: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generation$2f$prompt$2d$formatters$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildVisionUserContent"])(prompts.user, visionImages)
                            }
                        ],
                    ...
                    for(let attempt = 1; attempt <= MAX_STREAM_RETRIES + 1; attempt++){
                        try {
                            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$llm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["streamLLM"])(streamParams, 'scene-outlines-stream');
                            let fullText = '';
                            parsedOutlines = [];
                    ...
                    if (parsedOutlines.length > 0) {
                        // Replace sequential gen_img_N/gen_vid_N with globally unique IDs
                        const uniquifiedOutlines = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generation$2f$scene$2d$builder$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uniquifyMediaElementIds"])(parsedOutlines);
        ...
        log.error(`Outline streaming failed [requirement="${requirementSnippet ?? 'unknown'}...", model=${resolvedModelString ?? 'unknown'}]:`, error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2f7dced._.js.map