...
"[project]/app/api/verify-model/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])('Verify Model');
async function POST(req) {
    ...
    try {
        ...
        model = body.model;
        if (!model) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('MISSING_REQUIRED_FIELD', 400, 'Model name is required');
        }
        // Parse model string and resolve server-side fallback
        let languageModel;
        try {
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$resolve$2d$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveModel"])({
                modelString: model,
                apiKey: apiKey || '',
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('INVALID_REQUEST', 401, error instanceof Error ? error.message : String(error));
        }
        // Send a minimal test message
        const { text } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$ai$40$6$2e$0$2e$116_zod$40$4$2e$3$2e$6$2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generateText"])({
            model: languageModel,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$api$2d$response$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiError"])('INTERNAL_ERROR', 500, errorMessage);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1457b120._.js.map